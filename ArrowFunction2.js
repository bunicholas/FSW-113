const parts = [ 
 ...
 function parts2(){
     ...
     for(i=0; i<parts.length; i++){
         ...
         if(parts[i].aisle === "B3"){
             console.log('special packaging aisle: B3')
         }
         else if(parts[i].aisle === "J4"){
             console.log('hazardous materials aisle: J4')
         }
         else if(parts[i].aisle === 'H1'){
             console.log('where the small parts are stored aisle J4')
         }
         else if(parts[i].aisle === 'S'){
            console.log('need a forklift')
         }
         else if(parts[i].aisle === 'T'){
            console.log('need a forklift')
         }
         else if(parts[i].aisle === 'U'){
            console.log('need a forklift')
         }
         array.push(
            {partNbr:parts[i].partNbr, aisle:parts[i].aisle}
         )

         counter = counter + parts[i].qty
        }
